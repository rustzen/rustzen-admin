...
export const Route = createFileRoute("/analytics/events")({ component: AnalyticsEventsPage });
const pageSize = 20;
...
function AnalyticsEventsPage() {
    ...
    const query = { projectId, eventName: eventName || undefined, current, pageSize };
    ...
    return (
        <PageCard
            title="Events"
            description="Raw, paginated event stream with project and event filters."
            toolbar={
