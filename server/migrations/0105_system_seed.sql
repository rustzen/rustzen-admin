...
VALUES
    (0, 'Dashboard', 'dashboard:view', 1, 0, 1, TRUE), -- 仪表盘 id: 1
    ...
    (3, 'User Password', 'system:user:password', 3, 6, 1, TRUE), -- 用户密码 id: 9
    (3, 'User Status', 'system:user:status', 3, 7, 1, TRUE), -- 用户状态 id: 10
    ...
    (9, 'Role Options', 'system:role:options', 3, 6, 1, TRUE), -- 角色选项 id: 15
    ...
    (15, 'Menu Options', 'system:menu:options', 3, 6, 1, TRUE), -- 菜单选项 id: 21
    ...
    (21, 'Dictionary Options', 'system:dict:options', 3, 6, 1, TRUE), -- 字典选项 id: 27
    ...
    (27, 'Operation Logs Export', 'system:log:export', 3, 3, 1, TRUE) -- 操作日志导出 id: 30
ON CONFLICT (code) DO NOTHING;
